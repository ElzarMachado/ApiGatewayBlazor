...
//        => optionsBuilder.UseSqlServer("server=localhost; database=Ventas; integrated security=true; Encrypt= False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Clientes__3214EC075F9928A0");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__0988921090A68CD6");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Ventas__BC1240BDF856D2F0");
        });
